...
Deliver the first real Lyrica product slice as a tablet-first song reading flow built on ChordPro, using mock data and a repository boundary instead of auth or a real backend.
