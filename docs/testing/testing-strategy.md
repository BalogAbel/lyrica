...
- Planning write orchestration behavior, including optimistic-concurrency base-version capture, provisional slug allocation, retryable failed mutations, and empty-session delete enforcement
...
- Planning create/edit and session create/rename/delete flows, including failed-mutation review surfaces and sign-out warnings when planning mutations remain unsynced
...
- Local-first planning write persistence across database reopen, merged local planning write visibility, and explicit sign-out cleanup for both planning projection and planning mutations
...
- Planning write authorization enforcement for plan create/edit and session create/rename/delete RPCs
- Planning optimistic-concurrency checks for plan/session update and delete RPCs
...
- local-first planning write integration coverage for persisted pending mutations, merged local plan/session writes, and explicit sign-out cleanup
