...
- Robust widget finding in lazy-loaded views (e.g. `ListView`) by using scoped descendant finders (finding the container card first) and ensuring screen-size or scrolling is accounted for in CI.
