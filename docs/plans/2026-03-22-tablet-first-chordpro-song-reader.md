...
**Goal:** Build the first real Lyron Chords product slice as an asset-backed, tablet-first ChordPro song list and reader flow with parser diagnostics, view mode switching, semitone transposition, and shared font scaling.
