...
void main() {
  ...
  test('an existing pre-migration (v1) identity database gains '
      'membershipRevokedAt on upgrade and keeps its row intact (D5, '
      'ADR-035 Phase 4)', () async {
    ...
    )..where((t) => t.rowId.equals(1))).write(
    ...
    expect(updated.membershipRevokedAt?.toUtc(), DateTime.utc(2026, 8, 23));
