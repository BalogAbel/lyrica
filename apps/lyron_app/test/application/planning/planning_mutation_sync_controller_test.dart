...
void main() {
  group('PlanningMutationSyncController', () {
    ...
    test('retryMutation refuses to resend a permanently unauthorized mutation '
        'and surfaces the failure instead of silently doing nothing', () async {
    ...
    test('a 401 (unknown, not authorizationDenied) stays pending/retryable, '
