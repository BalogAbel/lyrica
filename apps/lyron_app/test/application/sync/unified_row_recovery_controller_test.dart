...
class _FakeSongStore implements SongMutationStore {
  ...
  // the tests in this file drive a pendingCreate song through
  // syncPendingSongs (the one pendingCreate record here is discarded
  // directly, never synced) -- that race is covered against the real
